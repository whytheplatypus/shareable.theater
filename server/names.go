...
// Translated from https://github.com/jitsi/js-utils/blob/master/random/roomNameGenerator.js
...
const templateText = `{{ Adjective }}{{ Pluralnoun }}{{ Verb }}{{ Adverb }}`
...
func Adjective() string {
	return randStr(ADJECTIVE)
}

func Pluralnoun() string {
	return randStr(PLURALNOUN)
}
...
func Adverb() string {
	return randStr(ADVERB)
}

// Create a template, add the function map, and parse the text.
var tmpl = template.Must(template.New("titleTest").Funcs(funcMap).Parse(templateText))
